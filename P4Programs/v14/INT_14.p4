...
control MyEgress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    action add_swtrace2(switchID_t swid) {
        ...
        hdr.int_header[1].hop_delay = (bit<32>)standard_metadata.deq_timedelta;
    ...
    action add_swtrace3(switchID_t swid) {
        ...
        hdr.int_header[2].hop_delay = (bit<32>)standard_metadata.deq_timedelta;
    ...
    action add_swtrace4(switchID_t swid) {
        ...
        hdr.int_header[3].hop_delay = (bit<32>)standard_metadata.deq_timedelta;
    ...
    action add_swtrace5(switchID_t swid) {
        ...
        hdr.int_header[4].hop_delay = (bit<32>)standard_metadata.deq_timedelta;
    ...
    action add_swtrace6(switchID_t swid) {
        ...
        hdr.int_header[5].hop_delay = (bit<32>)standard_metadata.deq_timedelta;
